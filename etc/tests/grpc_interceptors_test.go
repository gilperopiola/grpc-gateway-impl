...
//	rateLimiterCfg := &core.RateLimiterConfig{MaxTokens: 2, TokensPerSecond: 1}
...
//	interceptor := getGRPCRateLimiterInterceptor(limiter, &modules.Logger{Logger: logger})
//
...
//	logger := zap.New(core)
//	interceptor := getGRPCLoggerInterceptor(&modules.Logger{Logger: logger})
//
//	// Mock handler to simulate gRPC method execution.
