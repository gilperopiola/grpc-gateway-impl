...
//	http2 "github.com/gilperopiola/grpc-gateway-impl/app/modules/http"
//
...
//
//			http2.HandleHTTPError(context.Background(), mux, marshaller, recorder, request, tt.err)
//
...
//	middleware := http2.MuxWrapperMiddleware()
//
//	called := false
