...
var _ core.BaseSQLDB = &baseSQLDB{}
...
// Implements all basic methods to interact with the DB
...
func (this *baseSQLDB) Count(value *int64) core.BaseSQLDB { return &baseSQLDB{this.DB.Count(value)} }

func (this *baseSQLDB) Create(value any) core.BaseSQLDB { return &baseSQLDB{this.DB.Create(value)} }

func (this *baseSQLDB) Debug() core.BaseSQLDB { return &baseSQLDB{this.DB.Debug()} }

func (this *baseSQLDB) Error() error { return this.DB.Error }

func (this *baseSQLDB) Group(query string) core.BaseSQLDB { return &baseSQLDB{this.DB.Group(query)} }

func (this *baseSQLDB) Limit(value int) core.BaseSQLDB { return &baseSQLDB{this.DB.Limit(value)} }

func (this *baseSQLDB) Model(value any) core.BaseSQLDB { return &baseSQLDB{this.DB.Model(value)} }

func (this *baseSQLDB) Offset(value int) core.BaseSQLDB { return &baseSQLDB{this.DB.Offset(value)} }

func (this *baseSQLDB) Order(value string) core.BaseSQLDB { return &baseSQLDB{this.DB.Order(value)} }
...
func (this *baseSQLDB) Save(value any) core.BaseSQLDB { return &baseSQLDB{this.DB.Save(value)} }

func (this *baseSQLDB) Scan(to any) core.BaseSQLDB { return &baseSQLDB{this.DB.Scan(to)} }
...
func (this *baseSQLDB) Delete(val any, where ...any) core.BaseSQLDB {
	return &baseSQLDB{this.DB.Delete(val, where)}
}

func (this *baseSQLDB) Find(out any, where ...any) core.BaseSQLDB {
	return &baseSQLDB{this.DB.Find(out, where...)}
}

func (this *baseSQLDB) First(out any, where ...any) core.BaseSQLDB {
...
func (this *baseSQLDB) Or(query any, args ...any) core.BaseSQLDB {
	return &baseSQLDB{this.DB.Or(query, args...)}
}

func (this *baseSQLDB) Pluck(col string, val any) core.BaseSQLDB {
	return &baseSQLDB{this.DB.Pluck(col, val)}
}

func (this *baseSQLDB) Preload(query string, args ...any) core.BaseSQLDB {
	return &baseSQLDB{this.DB.Preload(query, args...)}
}

func (this *baseSQLDB) Raw(sql string, vals ...any) core.BaseSQLDB {
	return &baseSQLDB{this.DB.Raw(sql, vals...)}
}

func (this *baseSQLDB) Scopes(fns ...func(core.BaseSQLDB) core.BaseSQLDB) core.BaseSQLDB {
...
func (this *baseSQLDB) Unscoped() core.BaseSQLDB {
...
func (this *baseSQLDB) WithContext(ctx god.Ctx) core.BaseSQLDB {
	return &baseSQLDB{this.DB}
}

func (this *baseSQLDB) Where(q any, args ...any) core.BaseSQLDB {
